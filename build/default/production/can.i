        ...
        uint8_t txd)
{
    ...
    spiTransmitBuffer[0] = (uint8_t) ((0x0C << 4) + ((address >> 8) & 0xF));
    spiTransmitBuffer[1] = (uint8_t) (address & 0xFF);
    spiTransmitBuffer[2] = txd;
        ...
        uint8_t *rxd, uint16_t nBytes, _Bool fromRam, _Bool* crcIsCorrect)
{
    ...
    spiTransmitBuffer[0] = (uint8_t) ((0x0B << 4) + ((address >> 8) & 0xF));
    spiTransmitBuffer[1] = (uint8_t) (address & 0xFF);
    if (fromRam) {
        ...
        uint8_t *txd, uint16_t nBytes, _Bool fromRam)
{
    ...
    spiTransmitBuffer[0] = (uint8_t) ((0x0A << 4) + ((address >> 8) & 0xF));
    spiTransmitBuffer[1] = (uint8_t) (address & 0xFF);
    if (fromRam) {
        spiTransmitBuffer[2] = nBytes >> 2;
    } else {
        ...
        uint32_t *txd, uint16_t nWords)
{
    ...
    spiTransmitBuffer[0] = (0x02 << 4) + ((address >> 8) & 0xF);
    spiTransmitBuffer[1] = address & 0xFF;
